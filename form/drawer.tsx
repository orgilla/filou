...
const DualPane = createComponent(
  ({ theme }) => ({
    display: 'flex',
    '> article': {
      flex: 1
...
export default class DrawerForm extends Component {
  ...
  render() {
    ...
    const component = <StackedMenu keys={keys} renderMenu={this.renderMenu} />;
    ...
    return (
      <Drawer
        ...
        menu={
          ...
          >
            ...
            {!!lastKey && !isTabbbed && <Menu.Divider />}
            {!!lastKey &&
              !isTabbbed && (
                <Menu.Item
                  key="back"
      ...
      >
        {children ? <DualPane left={component} right={children} /> : component}
      </Drawer>
    );
  }
}
