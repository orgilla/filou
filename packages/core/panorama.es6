...
const Item = createComponent(
  ({ image, theme, index, deg }) => ({
    ...
    '> a': {
      ...
      width: '100%',
      boxShadow:
        'rgba(0, 0, 0, 0.005) 1px 1px 4px, rgba(0, 0, 0, 0.05) 0px 1px 3px',
      display: 'flex',
      ...
      '> .inner': {
        '> .tags': {
          ...
          '> span': {
            ...
            boxShadow:
              'rgba(0, 0, 0, 0.03) 1px 1px 4px, rgba(0, 0, 0, 0.03) 0px 1px 1px',
